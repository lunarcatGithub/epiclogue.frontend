...
import ReFeedback from '../Viewer/Feedback__ReFb';
...
const FB = (props) => {
  ...
  // useEffect(()=>{
  //   setfbToggleData(like ? 'post' : 'delete');
  //   setfbData({
  //     targetInfo: _id,
  //     targetType: fbUid && props.type === 'ReFb' ? 'Reply' : 'Feedback',
  //     })

    ...
    return (
        <PopupInner>
            <PopupTab>
              {List.map((i, key) => 
                <TabWrap key={key}>
                  <TabTitleWrap><TabTitle>{i.top}</TabTitle><TabDay>{i.date}</TabDay></TabTitleWrap>
                  <TabDpTitle><DpTitle>{i.title}</DpTitle></TabDpTitle>
                  <TabSubWrap><TabSub>{i.desc}</TabSub></TabSubWrap>
               </TabWrap>
              )
             }     
                </PopupTab>

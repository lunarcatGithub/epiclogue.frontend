...
export const EditorTextSetting = () => {
  ...
  const _detailText = detailText[selectedLanguage] || detailText[defaultLanguage],
    ...
    <TextSettingWrap>
       ...
       id='textSettingCtrl'
       styling={textSetting}
       onClick={()=>toggleTextSetting(!textSetting)}>{_detailText}</TextSettingBtn>
       {textSetting && 
       <TextSettingBox id='textSetting'>
           <TextSettingInner onClick={(e)=> e.stopPropagation()}>
            ...
            <CtrlBox>
                ...
                <CtrlInputBox>
                  <TextSpaceInput 
                  onChange={(e)=>setTextSpace(Number(e.target.value))}
                  value={textSpace}
                  />
                  <SpaceNumBox>
            ...
            <TextStyleWrap>
              ...
              <ButtonWrapUnder onClick={()=>toggleUnderbar(!textUnderbar)} styling={textUnderbar}>
                ...
                {/* 텍스트 정렬 */}
                <ButtonWrapLeft
                onClick={(e)=>UseRadioBtn(e.target.value)}
                value='left'
                styling={radioBtn === 'left'}
                >
                </ButtonWrapLeft>
                <ButtonWrapCenter 
                onClick={(e)=>UseRadioBtn(e.target.value)}
                value='center'
                styling={radioBtn === 'center'}
                >
                  </ButtonWrapCenter>
                <ButtonWrapRight 
                onClick={(e)=>UseRadioBtn(e.target.value)}
                value='right'
                styling={radioBtn === 'right'}
                >

...
export const InteractTab = () => {
  ...
  const _errorPush = errorPush[selectedLanguage] || errorPush[defaultLanguage],
    _uploadedPush =
      uploadedPush[selectedLanguage] || uploadedPush[defaultLanguage],
    _uploadedUpdatePush =
      uploadedUpdatePush[selectedLanguage] ||
      uploadedUpdatePush[defaultLanguage],
    _sharePush = sharePush[selectedLanguage] || sharePush[defaultLanguage],
    _tryAgainPush =
      tryAgainPush[selectedLanguage] || tryAgainPush[defaultLanguage],
    _notServicePush =
      notServicePush[selectedLanguage] || notServicePush[defaultLanguage],
  ...
  <>
      ...
      <PushBox bool={bool} color={color}>
        ...
        <Modal bool={bool}>
          ...
          <TextBox><InformText>{_nowUpload}</InformText></TextBox>
        </PushLayout>
        </Modal>
    }
    </>
